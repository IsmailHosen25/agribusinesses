...
export default function ProfileAdmin() {
  ...
  return (
    <div className={style.admindiv}>
        ...
        {role==="farm"? <div onClick={()=>setadminnav("addproducts")} style={{background: `${adminnav ==="addproducts" ? "#7AA2E3":""}`}}>Add Products</div>:""}
        ...
        {role==="vendor"? <YourOrder/>:""}
        {role==="farm"? adminnav ==="addproducts"? <Addproducts/>:<YourOrder/>:""  }
        </div>
    </div>
  )
}
